...
summary: "Evidence-First SEO Writing / Research Verification / Markdown Delivery / Content Refresh"
...
metadata: {"author": "aaron-he-zhu", "version": "22.1.0", "discipline": "content-engineering", "phase": "implement", "geo-relevance": "high", "hermes": {"tags": ["marketing", "seo-geo", "evidence-first", "implement"], "category": "seo-geo"}}
---
...
```
[1. Deep Research] ➔ [2. Data Verification] ➔ [3. Intent Resolution]
        │
        ▼
[4. First-Hand/Local Context] ➔ [5. Structural Outline] ➔ [6. Natural Voice Draft]
        │
        ▼
[7. SEO & Entity Topology] ➔ [8. Subtle AI-Pattern Polish]
        │
        ▼
...
1. **Research Accuracy & Verification (30%)**: Never cite sources by name alone. Tie metrics to specific survey years, reports, or tables (e.g. BBS HIES 2022, WHO 2016 Air Quality Table 1). Avoid medical or clinical claims without peer-reviewed data.
...
3. End with a verified **Primary Sources, Municipal Data & References** section containing exact report titles and years.
