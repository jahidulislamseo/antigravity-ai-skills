...
```mermaid
graph TD
    A[User Prompt / Request] --> B[STEP 1: 10-Year Senior Prompt Generation]
    B --> C[STEP 2: Autonomous Multi-Skill Chaining & Deep Execution]
    C --> D{User asked for a report?}
    D -- NO --> E[Deliver Direct Solutions, Code & Concrete Fixes]
    D -- YES --> F[Generate Visual HTML/PDF Report or Pitch Deck]
```
